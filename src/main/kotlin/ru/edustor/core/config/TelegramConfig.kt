...
open class TelegramConfig {
    ...
    open fun telegramBot(): TelegramBot? {
        val telegramToken = System.getenv("TELEGRAM_TOKEN") ?: throw IllegalArgumentException("Telegram token was not provided. Please set TELEGRAM_TOKEN environment variable.")
