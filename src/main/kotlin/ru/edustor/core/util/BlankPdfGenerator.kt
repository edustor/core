...
object BlankPdfGenerator {
    ...
    fun genPdf(count: Int = 1,
        ...
        val nowStr = "Generated by Edustor Core v${ru.edustor.core.EdustorApplication.VERSION} on ${now.format(DateTimeFormatter.ISO_LOCAL_DATE)} ${now.format(DateTimeFormatter.ISO_LOCAL_TIME)} MSK. " +
